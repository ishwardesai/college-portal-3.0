        ...
        <div class="container px-5 py-24 mx-auto flex flex-wrap">
          ...
          <div class="p-4 lg:w-1/4 md:w-full">
              <div class="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col bg-blue-50">
                ...
                <div class="flex-grow">
                  <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Ms. Shona</h2>
                  <p class="leading-relaxed text-base">FAC2020202</p>
                  <a href="/faculty/updateProfile" class="mt-3 text-blue-500 inline-flex items-center">Update
                        ...
                        {people.map((person) => (
                          <tr key={person.email}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              ...
                              <div className="text-sm text-gray-900">{person.reg}</div>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{person.year}</td>
            ...
            <div className="row">
              <div className="col-5">
                <div className="card" style={{ width: '18rem' }}>
                  <img className="card-img-top" src="ddccdc" alt="Card cap" />
                  <div className="card-body">
                    <h5 className="card-title">Ms Shona</h5>
                    <h5 className="card-title">2020COMPAST</h5>
