        ...
        <div class="container px-5 py-24 mx-auto flex flex-wrap">
          ...
          <div class="p-4 lg:w-1/4 md:w-full">
              <div class="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col bg-blue-50">
                ...
                <div class="flex-grow">
                  <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Admin</h2>
                  <p class="leading-relaxed text-base">Admin101123400</p>
            ...
            <div className="row">
              <div className="col-md-5">
                <div className="card" style={{ width: '18rem' }}>
                  <img className="card-img-top" src="dsdcsdcs" alt="Card cap" />
                  <div className="card-body">
                    <h5 className="card-title">Admin</h5>
                    <h5 className="card-title">Admin001</h5>
                  </div>
                </div>
              </div>
