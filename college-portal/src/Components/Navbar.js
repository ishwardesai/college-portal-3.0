  ...
  return (
    <div className=" h-full w-full flex justify-center items-start text-white border border-nav-inactive">
      <ul className="h-2/5 flex flex-col justify-between  items-stretch mt-20 p">
        ...
        >
          <Link to="/home">
            <p className="p-3">Ralph Rangnick</p>
          </Link>
          {/* <a href="/home"></a> */}
        </li>
        <li
        ...
        >
          <Link to="/student/testPerformance">
            <p className="p-3">Test Scores</p>
          </Link>
          {/* <a href="/student/testPerformance"></a> */}
        </li>
        <li
          className={` ${
            active === 'attendence'
        ...
        >
          <Link to="/student/attendence">
            <p className="p-3">Attendence</p>
          </Link>
          {/* <a href="#dcsd">Attendence</a> */}
        </li>
        <li
          className={` ${
            active === 'subjects'
        ...
        >
          <Link to="/student/getAllSubjects">
            <p className="p-3">Subjects</p>
          </Link>
          {/* <a href="#dcdscd">Subjects</a> */}
        </li>
        <li
          className={` ${
            active === 'password'
        ...
        >
          <Link to="/student/updatePassword">
            <p className="p-3">Update Password</p>
          </Link>
          {/* <a href="#sdcsd">Update Password</a> */}
        </li>
        <li
          className={` ${
            active === 'students'
        ...
        >
          <Link to="/student/studentDetails">
            <p className="p-3">Students</p>
          </Link>
          {/* <a href="#dcs">Students</a> */}
        </li>
      </ul>
    </div>
    // <div class="h-full hidden lg:block shadow-lg relative w-full">
